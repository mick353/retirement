...
assert(script.includes("normaliseElectionForBasis"), "Atlas does not source-gate elections per provider basis");
assert(script.includes("option = basis.elections"), "Atlas does not disable only the missing basis election");
